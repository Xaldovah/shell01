...
/**
 * init_paths - This function inits the path array by parsing PATH environ var.
...
/**
 * find_command - This function takes a string input (command)
...
/**
 * parse_input - This function parses user input command
 * @input: pointer to a string called input
 * @args: pointer to an array of strings called args
 *
 * Return: void.
 */
